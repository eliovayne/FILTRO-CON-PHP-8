...
switch ($_GET["op"]){
    case "listar":
        $datos=$pokemon->get_pokemon(@$_POST["tipo"],@$_POST["nombre"],@$_POST["attack"],@$_POST["defense"]);
        ...
        foreach($datos as $row){
            ?>
                <div class="list-group-item checkbox">
                    <label>
                        <input type="checkbox" class="filtrodetalle" name="tipos" value="<?php echo $row["tipo"]?>"> <?php echo $row["tipo"]?>
                    </label>
                </div>
            <?php
        }
